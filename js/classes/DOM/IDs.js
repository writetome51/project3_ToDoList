...
function IDs(){
    ...
    this.creationUnsuccessful = 'account-creation-unsuccessful';
    this.createAccountForm = 'create-account-form';
    this.dropdownMenus = 'dropdown-menus';
    this.loginAndCreateAccount = 'login-and-create-account';
    ...
    this.listNames = 'list-names';
    this.listNameHeader = 'list-name-header';
    this.newUsernameInput = 'create-account-username';
    this.createAccountPassword = 'create-account-password';
    this.createAccountPassword2 = 'create-account-password-2';
